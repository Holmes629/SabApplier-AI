...
function JobCard({ application, /* onCart */ }) {
  ...
  return (
    <>
      <div 
        className="block bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 border border-blue-100 p-3 hover:border-blue-300 hover:scale-[1.01] group cursor-pointer relative" 
      ...
      >
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-start justify-between mb-2 relative">
            <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg flex items-center justify-center shadow-sm group-hover:shadow-md transition-all duration-300">
          ...
          {/* Title */}
          <h3 className="text-base font-bold text-gray-900 mb-2 group-hover:text-blue-700 transition-colors duration-300 line-clamp-2 min-h-[2.5rem]">{application.title}</h3>
          ...
          {/* Dates */}
          <div className="space-y-1 bg-blue-50 rounded-lg p-2 mt-auto">
